...
**Signals:** PDFs are long-form — include all Investment Signal roles from `thesis.md` including `context`. Apply compression rule from `agency/research/positioning-framework.md`.
